...
import ThreeMeshUI from './build/three-mesh-ui.js';
import VRControl from './utils/VRControl.js';
import ShadowedLight from './utils/ShadowedLight.js';

// Remove direct import of JSON and PNG
// import FontJSON from './assets/Roboto-msdf.json';
// import FontImage from './assets/Roboto-msdf.png';

let FontJSON; // Will be loaded with fetch
const FontImage = './assets/Roboto-msdf.png'; // Use as string path
...
function makePanel() {
    ...
    const container = new ThreeMeshUI.Block({
        ...
        fontFamily: FontJSON,
        fontTexture: FontImage, // Use string path
        fontSize: 0.07,
        padding: 0.02,
        borderRadius: 0.11
    });
