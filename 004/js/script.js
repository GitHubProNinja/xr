...
import { createCube, setCubeColor } from './cube.js';
import { createColorMenu } from './menu.js';
...
function init() {
    ...
    // Modularized: create cube, menu, controllers
    cube = createCube();
    scene.add(cube);
...
// GUI and helpers remain unchanged
function createGUI() {
    const params = {
